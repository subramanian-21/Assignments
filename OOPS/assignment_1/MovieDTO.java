...
public class MovieDTO {
    ...
    MovieDTO(String movieName, String description){
        this.movieName = movieName;
        this.description = description;
        this.review = 0;
        this.reviewCount = 0;
    }
    MovieDTO(String movieName, String description,Map<String,String> casts){
        this.movieName = movieName;
        this.description = description;
        this.review = 0;
        this.casts = casts;
    ...
    public static void main(String[] args) {
        MovieDTO ragingBull = new MovieDTO("Raging Bull","This is a movie description of raging bull");
